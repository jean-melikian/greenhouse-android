...
public class LuminosityActivity extends BaseActivity {
    ...
    public void onResume() {
        super.onResume();
        setActionBarTitleDynamic(getResources().getString(R.string.menu_luminosity));
    }
    ...
    public String getTitleBarTitle() {
        return getResources().getString(R.string.menu_luminosity);
    }
